 ...
 */
public class PharmacieParserSousCategorie {

    public static PharmacieResultatParsingSousCategorie parserSousCategorie(Category subCategory,
            Document documentHTML, boolean premierAppel) throws IOException {
        return parserSousCategorie(subCategory, true, documentHTML);
    }

    private static PharmacieResultatParsingSousCategorie parserSousCategorie(Category subCategory,
